	...
	<table id="mitabla" class="table center-align col-s2">
		...
		*con un td pasamos un cuadro hacia la derecha en ña table->
			...
			<tbody>
				...
				<tr>
					<td>Seleccione tipo de Usuario
						<p>
						<label>
							<input name="rol" type="checkbox" value="3" />
							<span>Profesor</span>
						</label>
						</p>
						<p>
						<label>
							<input name="rol" type="radio" value="2" />
							<span>Coordinador</span>
						</label>
						</p>
						<p>
						<label>
							<input name="rol" type="radio" value="4" />
							<span>Estudiante</span>
						</label>
						</p>
						<p>
						<label>
							<input name="rol" type="radio" value="5" />
							<span>Personal</span>
						</label>
						</p>
